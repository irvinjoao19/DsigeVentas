...
class FormaPagoAdapter(private val listener: OnItemClickListener.FormaPagoListener) :
    RecyclerView.Adapter<FormaPagoAdapter.ViewHolder>() {

    private var count = emptyList<FormaPago>()

    fun addItems(list: List<FormaPago>) {
        count = list
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(m: FormaPago, listener: OnItemClickListener.FormaPagoListener) = with(itemView) {
